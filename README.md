...
My background in Production Engineering gave me a strong foundation in agility, optimization, and process improvement. I bring that mindset into development — building practical, efficient, real-world solutions.

```yaml
name: Bruno Fabbio
role: Frontend Developer / Data Analyst
focus: RESTful APIs, CI/CD, smart automation
currently: Growing into a full-stack developer
belief: Learn by doing. Ship, then improve.
```
